...
<main>
    ...
    <div class="area-bg" data-background="uploads/bg/area_bg.jpg">
        ...
        <section class="banner-area banner-bg tg-motion-effects"
            data-background="uploads/banner/{{ $topBanner->image }}">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product-item">
                        <div class="product-img">
                            <a href="{{ route('home.product', $sp->id) }}"><img src="uploads/product/{{ $sp->image }}"
                                    alt=""></a>
                        </div>
                ...
                <div class="col-lg-6 col-md-10">
                    <div class="product-item-two">
                        <div class="product-img-two">
                            <a href="{{ route('home.product', $fp->id) }}"><img src="uploads/product/{{ $sp->image }}"
                                    alt=""></a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-post-item">
                        ...
                        <div class="blog-post-content">
                            ...
                            <h4 class="title"><a href="blog-details.html">Chicken Sausage For Sale Humanely Raised</a>
                            </h4>
                            <p>Meat provide well shapd fresh and organic meat well animals is Humans.</p>
                            <div class="blog-post-bottom">
                                <a href="blog-details.html" class="link-btn">Read More</a>
